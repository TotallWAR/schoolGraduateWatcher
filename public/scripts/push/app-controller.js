    ...
    constructor() {
        ...
        this._applicationKeys = {
            publicKey: window.base64UrlToUint8Array(
                'BIYHVTeAHEGTzmA0BxUUBaf79aNW1Jv9emFsZsawUnXuHcBqJZpV7oFXRqCqu71D6P928aqSajhDKqeA-0je4Jg'),
            privateKey: window.base64UrlToUint8Array(
                'DPdnJpJi8Cf9MSSwYRTM3cTjF0PHcuYi8IWt7iISOds'),
        };
...
const applicationServerPublicKey = 'BL0mVscdXestt_2BbEj9LjwIAOSbX9hZ7Otkltu-uk-fwwGixuozCiN_U2QokjX2R3ZhMhPhuhOePaPN2pazG3A';
...
function updateSubscriptionOnServer(subscription) {
    ...
    if (subscription) {
        ...
        $.ajax({
            type: "POST",
            url: "/pushSubscription/subscribe",
            data: {
                subscriptionJSON
            }
        });
    ...
    swRegistration.pushManager.getSubscription()
        .then(function(subscription) {
            if (subscription !== null) {
                ...
                $.ajax({
                    type: "POST",
                    url: "/pushSubscription/unsubscribe",
                    data: {
                        subscriptionJSON
                    }
                });
